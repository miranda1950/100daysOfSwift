...
class GameScene: SKScene {
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for node in tappedNodes {
            ...
            if node.name == "charFriend" {
                ...
                run(SKAction.playSoundFileNamed("Classic_project14-files_Content_whackBad", waitForCompletion: false))
                ...
                run(SKAction.playSoundFileNamed("Classic_project14-files_Content_whack", waitForCompletion: false))
    ...
    func createEnemy() {
        ...
        if numRounds >= 30 {
            ...
            finalScore.text = "Your result: \(score)"
