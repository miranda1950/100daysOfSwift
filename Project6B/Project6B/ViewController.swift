...
class ViewController: UIViewController {
 ...
 /*       let viewsDictionary = ["label1": label1, "label2": label2, "label3": label3, "label4": label4, "label5": label5]
    ...
      }
       ...
       */
        ...
        for label in [label1, label2, label3, label4, label5] {
            ...
            /*label.widthAnchor.constraint(equalTo:view.widthAnchor).isActive = true -- jednako kao i leading i trailing*/
         ...
         /*  label.heightAnchor.constraint(greaterThanOrEqualToConstant: 70).isActive = true */
           ...
           label.heightAnchor.constraint(equalTo: height, multiplier: 0.2).isActive = true 
    ...
    /* anchors: - right and trailling are the same
                - left and leading are the same
     */
}
